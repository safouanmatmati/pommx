...
use Schema\Application\Repository\LanguageRepository;

final class LanguageDataProvider extends AbstractDataProvider
{
    /**
     * {@inheritdoc}
     */
    public function getSubresource(string $resourceClass, array $identifiers, array $context, string $operationName = null)
    {
        ...
        $id = $identifiers['countries'] ?? $identifiers['id'];
    }
}
